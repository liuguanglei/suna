...
export function ShareModal({
  ...
  const { data: threadData, isLoading: isChecking } = useThreadQuery(
    threadId || '',
  );
  ...
  const removeShareLink = async () => {
    ...
    try {
      ...
      console.error('Failed to remove shareable link');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const updatePublicStatus = async (isPublic: boolean) => {
    console.log(
      'Updating public status for thread:',
      threadId,
      'and project:',
      projectId,
      'to',
          ...
          {isChecking ? (
            ...
            <>
              <Alert>
                ...
                <AlertDescription>
                  This chat is publicly accessible. Anyone with the link can
            ...
            <div className="text-center space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  Create a shareable link that allows others to view this
