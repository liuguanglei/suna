      ...
      <CardHeader className="h-14 bg-zinc-50/80 dark:bg-zinc-900/80 backdrop-blur-sm border-b p-2 px-4 space-y-2">
        <div className="flex flex-row items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            >
              <ServerIcon className="w-5 h-5 text-neutral-600" />
          ...
          {!isStreaming && (
            ...
            >
              ...
              {isSuccess && result && !result.isError ? '执行成功' : '执行失败'}
            </Badge>
          )}
        </div>
      </CardHeader>
              ...
              <div className="bg-zinc-50/70 dark:bg-zinc-900/30 p-4 rounded-lg border border-zinc-100 dark:border-zinc-800">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div>
                    ...
                    >
                      {isSuccess && result && !result.isError ? '成功' : '失败'}
                    </span>
                  </div>
                </div>
              ...
              {(assistantTimestamp || toolTimestamp) && (
                <div className="flex items-center gap-4 text-xs text-zinc-500 dark:text-zinc-400 pt-2 border-t border-zinc-100 dark:border-zinc-800">
                  <div className="flex items-center gap-1">
                    ...
                    <span>
                      {toolTimestamp
                        ? `完成于 ${formatTimestamp(toolTimestamp)}`
                        : assistantTimestamp
                          ? `开始于 ${formatTimestamp(assistantTimestamp)}`
                          : ''}
                    </span>
                  </div>
                </div>
