      ...
      <div className="w-full divide-y divide-border">
        ...
        <section className="w-full relative overflow-hidden">
          ...
          <div className="relative z-10 flex justify-center px-6 pb-24">
            <div className="w-full max-w-lg rounded-xl bg-[#FFFFFF] dark:bg-[#F9FAFB]/[0.02] border border-border p-8">
              ...
              {/* Title */}
              <h3 className="xl:text-3xl font-medium tracking-tighter text-balance text-center mb-5 text-primary">
                奇智孔明AInnoGC
              </h3>
                  ...
                  {!isSignUp ? (
                    <>
                      <SubmitButton
                        ...
                        className="w-full h-12 bg-primary text-primary-foreground hover:bg-primary/90 transition-all shadow-md"
                        pendingText="登录中..."
                      >
                        登录
                      </SubmitButton>
